...
# file_path = project_folder / "csv" / "twogaussians33.csv"
...
# # --------------------------------------------------
# # Step 3: Calculate mean vectors for both classes
# # --------------------------------------------------

# # Get points belonging to class 0
# class_0 = data[data["label"] == 0][["x1", "x2"]]

# # Get points belonging to class 1
...
# print(f"x1 = {mean_class_0['x1']:.15f}")
# print(f"x2 = {mean_class_0['x2']:.15f}")

# print("\nMean vector for Class 1:")
# print(f"x1 = {mean_class_1['x1']:.15f}")
# print(f"x2 = {mean_class_1['x2']:.15f}")
...
# # Eigen decomposition for Class 0 covariance matrix
# eigenvalues_0, eigenvectors_0 = np.linalg.eigh(cov_class_0)

# # Eigen decomposition for Class 1 covariance matrix
...
# # Step 6: First linear transformation
# # --------------------------------------------------

# # Convert class data to NumPy arrays
# points_0 = class_0.to_numpy()
# points_1 = class_1.to_numpy()

# # Transform both classes using eigenvectors of Class 0
# transformed_0 = points_0 @ eigenvectors_0
# transformed_1 = points_1 @ eigenvectors_0

# print("\nFirst transformation completed.")

# # Step 7: Mean vectors and covariance matrices
...
# cov_transformed_0 = np.cov(transformed_0, rowvar=False, bias=True)
# cov_transformed_1 = np.cov(transformed_1, rowvar=False, bias=True)

# print("\nMean vector for Class 0 after first transformation:")
# print(mean_transformed_0)

# print("\nMean vector for Class 1 after first transformation:")
# print(mean_transformed_1)

# print("\nCovariance matrix for Class 0 after first transformation:")
# print(cov_transformed_0)

# print("\nCovariance matrix for Class 1 after first transformation:")
# print(cov_transformed_1)

# # Step 8: Whitening transformation
# # --------------------------------------------------

# # Create the whitening matrix using the eigenvalues
# whitening_matrix = np.diag(1 / np.sqrt(eigenvalues_0))

# print("\nWhitening matrix:")
# print(whitening_matrix)

# # Apply the whitening transformation to both classes
# whitened_0 = transformed_0 @ whitening_matrix
# whitened_1 = transformed_1 @ whitening_matrix

# print("\nWhitening transformation completed.")

# # Step 9: Mean vectors and covariance matrices
# # after whitening
# # --------------------------------------------------
...
# # Calculate new covariance matrices
# cov_whitened_0 = np.cov(whitened_0, rowvar=False, bias=True)
# cov_whitened_1 = np.cov(whitened_1, rowvar=False, bias=True)

# print("\nMean vector for Class 0 after whitening:")
# print(mean_whitened_0)

# print("\nMean vector for Class 1 after whitening:")
# print(mean_whitened_1)

# print("\nCovariance matrix for Class 0 after whitening:")
# print(cov_whitened_0)

# print("\nCovariance matrix for Class 1 after whitening:")
# print(cov_whitened_1)

# # Step 10: Eigen decomposition after whitening
# # --------------------------------------------------

# # Eigen decomposition of whitened Class 1 covariance matrix
# eigenvalues_final, eigenvectors_final = np.linalg.eigh(cov_whitened_1)
...
# # Apply the final eigenvector transformation
# final_0 = whitened_0 @ eigenvectors_final
# final_1 = whitened_1 @ eigenvectors_final

# print("\nFinal transformation completed.")

# # Step 12: Mean vectors and covariance matrices
# # after the final transformation

# mean_final_0 = final_0.mean(axis=0)
# mean_final_1 = final_1.mean(axis=0)

# cov_final_0 = np.cov(final_0, rowvar=False, bias=True)
# cov_final_1 = np.cov(final_1, rowvar=False, bias=True)

# print("\nMean vector for Class 0 after final transformation:")
# print(mean_final_0)

# print("\nMean vector for Class 1 after final transformation:")
# print(mean_final_1)

# print("\nCovariance matrix for Class 0 after final transformation:")
# print(cov_final_0)

# print("\nCovariance matrix for Class 1 after final transformation:")
# print(cov_final_1)

# # Step 13: Visualize all transformation stages
# # --------------------------------------------------
